...
class _$TransactionStateImpl implements _TransactionState {
  ...
  @override
  String toString() {
    return 'TransactionState(transactions: $transactions, filteredTransactions: $filteredTransactions, totalIncome: $totalIncome, totalExpense: $totalExpense, balance: $balance, isLoading: $isLoading, selectedFilter: $selectedFilter, errorMessage: $errorMessage)';
  }
